...
<div class="timeline-box shadow">
  <div class="timeline-main">
    <h1><i class="fa fa-clock-o"></i>MyOA</h1>
    <div class="timeline-line"></div>
    <div class="timeline-year">
      <h2><a class="yearToggle">2023 年</a><i class="fa fa-caret-down fa-fw"></i></h2>
        ...
        <ul>
          <li>
            ...
            <div class="content animated fadeInRight">
              完成SSM整合，加入Layui框架。<i class="layui-icon"></i></div>
            <div class="clear"></div>
          </li>
          <li>
            <div class="h4 animated fadeInLeft">
            ...
            <p class="dot-circle animated "><i class="fa fa-dot-circle-o"></i></p>
            <div class="content animated fadeInRight">
              完成登录，用户角色数据表格的增删查改，并实现角色授权功能。<strong><em>（V1.0）</em></strong><i class="layui-icon layui-icon-fonts-code" style="font-size: 30px; color: #1E9FFF;"></i>
            </div>
            <div class="clear"></div>
          </li>
          <li>
            ...
            <p class="dot-circle animated "><i class="fa fa-dot-circle-o"></i></p>
            <div class="content animated fadeInRight">
              加入，部门管理，请假管理，会议室管理等功能。<strong><em>（V2.0）</em></strong><i class="layui-icon layui-icon-chart-screen" style="font-size: 30px; color: #1E9FFF;"></i>
            </div>
            <div class="clear"></div>
          </li>
          <li>
          ...
          <li>
            ...
            <%--<p class="dot-circle animated "><i class="fa fa-dot-circle-o"></i></p>--%>
            <div class="content animated fadeInRight">
              修改一些小bug<strong><em>（V4.1）</em></strong><i class="layui-icon layui-icon-layouts" style="font-size: 30px; color: #1E9FFF;"></i>
            </div>
            <div class="clear"></div>
          </li>
          <li>
            ...
            <%--<p class="dot-circle animated "><i class="fa fa-dot-circle-o"></i></p>--%>
            <div class="content animated fadeInRight">
              基本完成<strong><em>（V4.1）</em></strong><i class="layui-icon layui-icon-layouts" style="font-size: 30px; color: #1E9FFF;"></i>
            </div>
            <div class="clear"></div>
          </li>
        </ul>
